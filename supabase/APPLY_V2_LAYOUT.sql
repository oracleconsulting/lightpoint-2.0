-- ============================================================================
-- APPLY V2 LAYOUT - Bulletproof version using dollar-quoting
-- Run this in Supabase SQL Editor to update the blog post
-- ============================================================================

UPDATE blog_posts
SET structured_layout = $JSON${
  "theme": {
    "mode": "light",
    "name": "lightpoint"
  },
  "components": [
      ...
      "props": {
        ...
        "steps": [
          ...
          },
          {
            ...
            "description": "Two sentences maximum stating the breach and the redress you seek. Be specific about amounts and references."
          },
          {
            "title": "Chronology",
          ...
          },
          {
            ...
            "description": "Quote the Compliance Handbook and Taxpayers' Charter directly. These are commitments HMRC must follow."
          },
          {
    ...
    },
    {
      ...
      "props": {
        "icon": "💡",
        "label": "Pro Tip",
        "text": "Quote the Taxpayers' Charter directly in your complaint. It states HMRC will treat you even-handedly, with courtesy and respect. The three-month delay, with no explanation despite repeated contact, fails this commitment.",
        "variant": "blue"
      }
    },
    {
...
SELECT 
  ...
  (structured_layout->'components'->0->>'type') as first_component_type,
  (structured_layout->'components'->1->>'type') as second_component_type
FROM blog_posts 
WHERE slug = 'why-hmrc-complaints-fail-how-to-fix';
