// ============================================================================
// HMRC COMPLAINTS BLOG - CORRECT LAYOUT
// Properly structured to match the original markdown content
// ============================================================================

import type { BlogLayout } from './types';

/**
 * This layout correctly represents the blog post structure.
 * 
 * Key differences from broken version:
 * 1. Paragraphs are individual items, not merged walls of text
 * 2. Each section is properly delineated
 * 3. Stats only appear where intended
 * 4. No random "Traditional/Better Approach" cards
 */
export const hmrcComplaintsLayout: BlogLayout = {
  theme: {
    mode: 'light',
    name: 'lightpoint',
  },
      ...
      props: {
        ...
        steps: [
          ...
          },
          {
            ...
            description: "Be specific: \"Due to HMRC's delay: Client cannot submit VAT returns or reclaim input tax (£2,400 accumulated). Client has lost a contract worth £15,000 due to inability to provide VAT number. Professional fees of £1650 incurred (6 hours chasing registration).\"",
          },
          {
            number: "06",
          ...
          },
          {
            ...
            description: "\"I require acknowledgement within 48 hours and a substantive response within 15 working days per your published standards. Should this matter not resolve satisfactorily, I will escalate to Tier Two and subsequently the Adjudicator's Office, where 41% of HMRC complaints were upheld in 2023-24.\"",
          },
        ],
        variant: "grid",
      },
...
export default hmrcComplaintsLayout;
