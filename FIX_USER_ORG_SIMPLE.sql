-- FIXED: Comprehensive check of user and organization data
...
-- 3. If organization doesn't exist, create it (FIXED - removed updated_at)
...
-- 6. Check if there are any complaints for this organization
SELECT 
  id,
  complaint_reference,
  status,
